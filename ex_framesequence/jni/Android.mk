...
# TODO (message_cube) add giflib static library
include $(CLEAR_VARS)

LOCAL_MODULE := giflib-prebuilt
LOCAL_SRC_FILES := external/giflib/$(TARGET_ARCH_ABI)/libgif.a
...
# TODO (message_cube) Add WebP in the future.
# https://developers.google.com/speed/webp/
FRAMESEQUENCE_INCLUDE_WEBP = false
