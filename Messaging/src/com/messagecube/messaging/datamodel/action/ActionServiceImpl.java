...
import com.messagecube.messaging.util.LoggingTimer;
import com.messagecube.messaging.util.WakeLockHelper;
...
public class ActionServiceImpl extends IntentService {
    ...
    public static class PendingActionReceiver extends BroadcastReceiver {
        static final String ACTION = "com.messagecube.messaging.datamodel.PENDING_ACTION";
