...
import com.messagecube.messaging.datamodel.MessageNotificationState.BundledMessageNotificationState;
import com.messagecube.messaging.datamodel.MessageNotificationState.ConversationLineInfo;
import com.messagecube.messaging.datamodel.MessageNotificationState.MultiConversationNotificationState;
import com.messagecube.messaging.datamodel.MessageNotificationState.MultiMessageNotificationState;
import com.messagecube.messaging.datamodel.action.MarkAsReadAction;
import com.messagecube.messaging.datamodel.action.MarkAsSeenAction;
import com.messagecube.messaging.datamodel.action.RedownloadMmsAction;
import com.messagecube.messaging.datamodel.data.ConversationListItemData;
import com.messagecube.messaging.datamodel.media.AvatarRequestDescriptor;
import com.messagecube.messaging.datamodel.media.ImageResource;
import com.messagecube.messaging.datamodel.media.MediaRequest;
import com.messagecube.messaging.datamodel.media.MediaResourceManager;
import com.messagecube.messaging.datamodel.media.MessagePartVideoThumbnailRequestDescriptor;
import com.messagecube.messaging.datamodel.media.UriImageRequestDescriptor;
import com.messagecube.messaging.datamodel.media.VideoThumbnailRequest;
import com.messagecube.messaging.sms.MmsSmsUtils;
...
import com.messagecube.messaging.util.BugleGservices;
import com.messagecube.messaging.util.BugleGservicesKeys;
import com.messagecube.messaging.util.BuglePrefs;
import com.messagecube.messaging.util.BuglePrefsKeys;
import com.messagecube.messaging.util.ContentType;
import com.messagecube.messaging.util.ConversationIdSet;
import com.messagecube.messaging.util.ImageUtils;
import com.messagecube.messaging.util.LogUtil;
import com.messagecube.messaging.util.NotificationPlayer;
import com.messagecube.messaging.util.OsUtil;
import com.messagecube.messaging.util.PendingIntentConstants;
import com.messagecube.messaging.util.PhoneUtils;
import com.messagecube.messaging.util.RingtoneUtil;
import com.messagecube.messaging.util.ThreadUtil;
...
//            .setPublicVersion(null)    // TODO: when/if we ever support different
    ...
    private static synchronized void doNotify(final Notification notification,
        ...
        // TODO: Update the count on the app icon.
        BadgeUtils.setBadge(Factory.get().getApplicationContext());
    }
