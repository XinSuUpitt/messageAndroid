...
import com.messagecube.messaging.util.ContactRecipientEntryUtils;
...
public class ContactRecipientAutoCompleteView extends RecipientEditTextView {
    ...
    public ContactRecipientAutoCompleteView(final Context context, final AttributeSet attrs) {
        // FIXME: freeme.biantao. support.v7 has no 'R.style.ColorAccentGrayOverrideStyle'
        //super(new ContextThemeWrapper(context, R.style.ColorAccentGrayOverrideStyle), attrs);
        super(new ContextThemeWrapper(context, com.messagecube.messaging.R.style.ColorAccentGrayOverrideStyle), attrs);
