...
public class ConversationListActivity extends AbstractConversationListActivity {
    ...
    public static final String BACKGROUNDIMAGE_FILENAME = "BackgroundImage_file_name";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        drawable = sharedPreferences.getInt(BACKGROUNDIMAGE, R.drawable.background_default);
        System.out.println("Background image for main list is "+ sharedPreferences.getInt(BACKGROUNDIMAGE, 1111));
        //drawerLayout.setBackgroundResource(drawable);
        Trace.endSection();
        invalidateActionBar();
    }
...
//                return true;
    ...
    private void onChangeBackground() {
        Intent intent = new Intent(getApplicationContext(), Background_Image.class);
