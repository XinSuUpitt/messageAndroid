...
package com.messagecube.messaging.receiver;
...
import com.messagecube.messaging.datamodel.action.ProcessDeliveryReportAction;
import com.messagecube.messaging.datamodel.action.ProcessDownloadedMmsAction;
import com.messagecube.messaging.datamodel.action.ProcessSentMessageAction;
import com.messagecube.messaging.datamodel.data.ParticipantData;
import com.messagecube.messaging.sms.MmsUtils;
import com.messagecube.messaging.sms.SmsSender;
...
public class SendStatusReceiver extends BroadcastReceiver {
    public static final String MESSAGE_SENT_ACTION =
            "com.messagecube.messaging.receiver.SendStatusReceiver.MESSAGE_SENT";
    public static final String MESSAGE_DELIVERED_ACTION =
            "com.messagecube.messaging.receiver.SendStatusReceiver.MESSAGE_DELIVERED";
    public static final String MMS_SENT_ACTION =
            "com.messagecube.messaging.receiver.SendStatusReceiver.MMS_SENT";
    public static final String MMS_DOWNLOADED_ACTION =
            "com.messagecube.messaging.receiver.SendStatusReceiver.MMS_DOWNLOADED";
