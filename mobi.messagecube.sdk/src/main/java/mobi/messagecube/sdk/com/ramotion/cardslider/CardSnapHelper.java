package mobi.messagecube.sdk.com.ramotion.cardslider;
...
public class CardSnapHelper extends LinearSnapHelper {
                                              ...
                                              @NonNull View targetView)
    {
        ...
        if (out[0] != 0) {
            ...
            // TODO: com.ramotion.cardslider uses SDK 25.
            // com.messagecube.sdk uses SDK 24.
            // The function above is not available in SDK 25. So we have to the following function.
            recyclerView.smoothScrollBy(out[0], 0);
        }
